import random
import time #retrieving the current time or waiting during code execution
from receiver import RDTReceiver #The RDT protocol uses udt_send and udt_receive provided by network.py to transfer bytes between the client and server machines.
...
class NetworkLayer:
    ...
    def __init__(self, reliability=1.0, delay=1.0, pkt_corrupt=True, ack_corrupt=True):
        ...
        """
        self.reliability = reliability #beta3t el network
        self.packet = None
        self.reply = None
        self.delay = delay
    ...
    def __packet_corruption_probability(self):#choose whether to corrupt the packet or not
    ...
    def __corrupt_packet(self): #choose which part in the packet to corrupt
    ...
    def __corrupt_reply(self):#put the wrong data
    ...
    def udt_send(self, frame):
        ...
        :param frame: a python dictionary represent the  sender's packet or a receiver's reply
